...
let CreateBookService = class CreateBookService {
    constructor(bookRepo) {
        this.bookRepo = bookRepo;
    }
    async execute(body) {
        const book = book_1.Book.create(body);
        const result = await this.bookRepo.save(book);
        return result;
    }
};
exports.CreateBookService = CreateBookService;
exports.CreateBookService = CreateBookService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)('IBookRepo')),
    __metadata("design:paramtypes", [Object])
], CreateBookService);
//# sourceMappingURL=create-book.service.js.map